...
func Test_sealAndSave(t *testing.T) {
	...
	assert.Equal(t, "state/mystage/kube-resources/riser-managed/myns/secrets/myapp/bitnami.com.sealedsecret.myapp-mysecret-1.yaml", committer.Commits[0].Files[0].Name)
}
